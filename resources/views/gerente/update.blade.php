    ...
    <div class="container mx-auto mt-8">
        <div class="card shadow-lg">
            <div class="card-header bg-blue-600 text-white">
                <h3 class="card-title">{{ __('Editar Condomino') }}</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('gerente.update', $condomino->nif) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="telefone" class="block text-gray-700">{{ __('Telefone:') }}</label>
                    ...
                    <div class="mb-4">
                        <label for="condominio_id" class="block text-gray-700">{{ __('Condomínio:') }}</label>
